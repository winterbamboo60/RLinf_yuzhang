...
class LeRobotPiperDataConfig(DataConfigFactory):
    """Data configuration for Piper leader-follower LeRobot datasets."""
    ...
    def generate_observations(
        ...
        """Creates an input example for the Piper policy."""
        return {
    ...
    def create(
        ...
        data_transforms = _transforms.Group(
            ...
            outputs=[
                piper_policy.PiperOutputs(output_action_dim=self.output_action_dim)
            ],
        )
